...
public class PinkDiamondCrosswordPLTWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(PinkDiamondCrosswordPLTWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/PinkDiamondCrosswordPLTIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/PinkDiamondCrosswordPLTIW/InitOutcome.xml").getDocumentElement();
